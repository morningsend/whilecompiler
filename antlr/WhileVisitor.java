...
public interface WhileVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link WhileParser#readStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReadStatement(WhileParser.ReadStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link WhileParser#blockStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBlockStatement(WhileParser.BlockStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link WhileParser#writeStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWriteStatement(WhileParser.WriteStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link WhileParser#writeLineStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWriteLineStatement(WhileParser.WriteLineStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link WhileParser#skipStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSkipStatement(WhileParser.SkipStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link WhileParser#returnStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReturnStatement(WhileParser.ReturnStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link WhileParser#functionDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link WhileParser#whileStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link WhileParser#parameterList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link WhileParser#arrayAccess}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArrayAccess(WhileParser.ArrayAccessContext ctx);
	/**
	 * Visit a parse tree produced by {@link WhileParser#arrayLiteral}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArrayLiteral(WhileParser.ArrayLiteralContext ctx);
	/**
	 * Visit a parse tree produced by {@link WhileParser#parenExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParenExpression(WhileParser.ParenExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link WhileParser#booleanConstant}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBooleanConstant(WhileParser.BooleanConstantContext ctx);
	/**
	 * Visit a parse tree produced by {@link WhileParser#factor}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
